...
const p2002Result = (0, errorHandler_1.createErrorResponse)(p2002Error, 'customer');
...
const p2025Result = (0, errorHandler_1.createErrorResponse)(p2025Error, 'invoice', 'Failed to delete invoice');
...
const p2003Result = (0, errorHandler_1.createErrorResponse)(p2003Error, 'customer');
...
const genericResult = (0, errorHandler_1.createErrorResponse)(genericError, 'product', 'Failed to load products');
...
console.log('-'.repeat(70));
const nullResult = (0, errorHandler_1.createErrorResponse)(null);
...
const invoiceContext = (0, errorHandler_1.sanitizeError)(contextError, 'invoice');
const productContext = (0, errorHandler_1.sanitizeError)(contextError, 'product');
const customerContext = (0, errorHandler_1.sanitizeError)(contextError, 'customer');
