 ...
 */
function sanitizeError(error, context, fallbackMessage = "An error occurred while processing your request") {
 ...
 */
function createErrorResponse(error, context, fallbackMessage) {
