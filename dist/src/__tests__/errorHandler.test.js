...
describe('Error Handler', () => {
    describe('sanitizeError', () => {
        test('should sanitize Prisma P2002 (unique constraint) errors', () => {
            ...
            const result = (0, errorHandler_1.sanitizeError)(prismaError);
        ...
        test('should provide context-specific messages for invoice operations', () => {
            ...
            const result = (0, errorHandler_1.sanitizeError)(prismaError, 'invoice');
        ...
        test('should provide context-specific messages for product operations', () => {
            ...
            const result = (0, errorHandler_1.sanitizeError)(prismaError, 'product');
        ...
        test('should sanitize generic Error objects without exposing stack traces', () => {
            ...
            const result = (0, errorHandler_1.sanitizeError)(error);
        ...
        test('should handle null/undefined errors gracefully', () => {
            expect((0, errorHandler_1.sanitizeError)(null)).toBe('An error occurred while processing your request');
            expect((0, errorHandler_1.sanitizeError)(undefined)).toBe('An error occurred while processing your request');
        });
        test('should use fallback message when provided', () => {
            ...
            const result = (0, errorHandler_1.sanitizeError)(error, undefined, fallback);
        ...
        test('should never expose Prisma in error messages', () => {
            ...
            testErrors.forEach(err => {
                const result = (0, errorHandler_1.sanitizeError)(err);
    ...
    describe('createErrorResponse', () => {
        test('should return properly formatted error response object', () => {
            ...
            const response = (0, errorHandler_1.createErrorResponse)(error, undefined, 'Operation failed');
        ...
        test('should sanitize errors in response', () => {
            ...
            const response = (0, errorHandler_1.createErrorResponse)(prismaError);
...
describe('Error Sanitization Integration', () => {
    test('example: simulating invoice deletion with Prisma error', () => {
        ...
        const response = (0, errorHandler_1.createErrorResponse)(prismaError, 'invoice', 'Failed to delete invoice');
    ...
    test('example: simulating unique constraint violation', () => {
        ...
        const response = (0, errorHandler_1.createErrorResponse)(prismaError, 'customer', 'Failed to create customer');
        // Verify sanitization
        expect(response.message).not.toContain('constraint');
