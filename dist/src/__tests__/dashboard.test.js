...
jest.mock('@prisma/client', () => {
    const m = {
        products: {
            ...
            findMany: jest.fn().mockImplementation(async (opts) => {
...
describe('Dashboard API', () => {
    ...
    test('Rate limiter returns 429 after threshold', async () => {
        ...
        const first = await (0, supertest_1.default)(app).get('/dashboard');
        expect(first.status).toBe(200);
        const second = await (0, supertest_1.default)(app).get('/dashboard');
