...
describe("GET /products search", () => {
    ...
    it("returns products filtered by search and caches repeated queries", async () => {
        ...
        const res1 = await (0, supertest_1.default)(app).get("/products").query({ search: "nutella" }).expect(200);
        ...
        const res2 = await (0, supertest_1.default)(app).get("/products").query({ search: "nutella" }).expect(200);
